 ...
 * @author p1805797
 */
public class SaisirParamB extends javax.swing.JFrame {

    private Accueil app;
    /**
     * Creates new form SaisirParamB
     */
    public SaisirParamB(Accueil acc) {
        initComponents();
        app = acc;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SaisirParamB(new Accueil()).setVisible(true);
            }
        });
    }
